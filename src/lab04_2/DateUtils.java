...
public class DateUtils {
    public static int compareDate(MyDate a,MyDate b)
    {
    ...
    public static void sorttingDate(ArrayList<MyDate> myDates) {
    ...
    public static int convertStringDateToNumber(MyDate a)
    {
